    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                ...
                @include('backend.includes.site_nav')
        ...
        <script src="{{asset('/')}}backend-asset/assets/demo/chart-area-demo.js"></script>
        <script src="{{asset('/')}}backend-asset/assets/demo/chart-bar-demo.js"></script>
